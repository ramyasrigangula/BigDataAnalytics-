...
- (void)perform:(NSString *)command {
    ...
    if ([cmd isEqualToString:@"LEFT"]) {
        ...
        [self.Romo3 turnByAngle:60 withRadius:.2 speed:0.75 finishingAction:RMCoreTurnFinishingActionDriveBackward completion:^(BOOL success, float heading) {
            [self.Romo3 turnByAngle:60 withRadius:.2 speed:0.75 finishingAction:RMCoreTurnFinishingActionDriveForward completion:^(BOOL success, float heading) {
                [self.Romo3 turnByAngle:60 withRadius:.2 speed:0.75 finishingAction:RMCoreTurnFinishingActionDriveForward completion:^(BOOL success, float heading) {
        ...
        [self.Romo3 tiltByAngle:135 completion:^(BOOL success) {
